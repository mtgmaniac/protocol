...
static func core() -> Array:
	return [
		...
		{"targets": ["enemy_pip", "enemy_die"], "separate": true, "text": "Enemies show their next action here. This drone plans to deal 7 damage to Strike."},
...
static func practice() -> Array:
	return [
		...
		{"targets": ["ability:pulse", "die:pulse"], "separate": true, "title": "BURN", "glyph": "burn", "text": "Pulse deals 6 damage now and 2 Burn damage next turn. Target the same drone: Mark increases this turn's hit by 50%.", "advance": "assigned", "hero": "pulse"},
